...
from app.models import ConnectionTableSelection, DataDefinition, DataDefinitionTable, DataObject, System, SystemConnection
...
def _build_table_context(table_link: DataDefinitionTable) -> TableContext:
    ...
    linked_selection: ConnectionTableSelection | None = resolve_connection_table_selection(table_link)
    ...
    return TableContext(
        ...
        workspace_id=data_object.workspace_id if data_object else None,
...
def resolve_table_context(
    ...
    *,
    ...
    context = _build_table_context(table_link)
...
def resolve_table_contexts_for_data_object(
    ...
    *,
    ...
    table_links: Iterable[DataDefinitionTable] = query.all()
...
def resolve_all_table_contexts(db: Session, workspace_id: UUID | None = None) -> List[TableContext]:
    query = (
        db.query(DataDefinitionTable)
        .join(DataDefinition)
        .join(DataObject)
