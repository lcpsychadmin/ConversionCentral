...
class DataQualityTextProfileStats(BaseModel):
    ...
    actual_value_count: Optional[int] = Field(default=None, alias="actualValueCount")
    null_value_count: Optional[int] = Field(default=None, alias="nullValueCount")
    zero_length_count: Optional[int] = Field(default=None, alias="zeroLengthCount")
    dummy_value_count: Optional[int] = Field(default=None, alias="dummyValueCount")
    ...
    includes_digit_count: Optional[int] = Field(default=None, alias="includesDigitCount")
    ...
    date_value_count: Optional[int] = Field(default=None, alias="dateValueCount")
