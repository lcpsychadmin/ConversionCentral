...
import { createRelease, deleteRelease, fetchReleases, updateRelease } from '../services/releaseService';
...
export const useReleases = () => {
    ...
    const releasesQuery = useQuery(RELEASES_KEY, fetchReleases);
    ...
    const updateMutation = useMutation(({ id, input }) => updateRelease(id, input), {
        onSuccess: () => {
