...
import { createProcessArea, deleteProcessArea, fetchProcessAreas, updateProcessArea } from '../services/processAreaService';
...
export const useProcessAreas = () => {
    ...
    const processAreasQuery = useQuery(PROCESS_AREAS_KEY, fetchProcessAreas);
    ...
    const updateMutation = useMutation(({ id, input }) => updateProcessArea(id, input), {
        onSuccess: () => {
