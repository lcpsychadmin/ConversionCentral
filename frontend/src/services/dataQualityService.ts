...
interface TestGenTextProfileStatsResponse {
  ...
  value_count?: number | null;
  valueCount?: number | null;
  actual_value_count?: number | null;
  actualValueCount?: number | null;
  null_value_count?: number | null;
  nullValueCount?: number | null;
  zero_length_count?: number | null;
  zeroLengthCount?: number | null;
  dummy_value_count?: number | null;
  ...
  includes_digit_count?: number | null;
...
const mapTextProfileStats = (
  ...
  const stats: DataQualityTextProfileStats = {
    recordCount: payload.record_count ?? payload.recordCount ?? null,
    valueCount: payload.value_count ?? payload.valueCount ?? null,
    actualValueCount: payload.actual_value_count ?? payload.actualValueCount ?? null,
    nullValueCount: payload.null_value_count ?? payload.nullValueCount ?? null,
    zeroLengthCount: payload.zero_length_count ?? payload.zeroLengthCount ?? null,
    dummyValueCount: payload.dummy_value_count ?? payload.dummyValueCount ?? null,
    ...
    includesDigitCount: payload.includes_digit_count ?? payload.includesDigitCount ?? null,
    ...
    dateValueCount: payload.date_value_count ?? payload.dateValueCount ?? null,
